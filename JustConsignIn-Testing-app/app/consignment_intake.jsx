...
import {
  ...
  Users, WalletCards, CircleDollarSign,
...
import { Header, PhotoPicker } from './components/consignment/SharedPieces';
...
/* ---------- shared components now live in their own files:
   ...
   Header/PhotoPicker -> ./components/consignment/SharedPieces.jsx
   DashboardScreen       -> ./pages/consignment/DashboardScreen.jsx
   ChooseConsignorScreen -> ./pages/consignment/ChooseConsignorScreen.jsx
